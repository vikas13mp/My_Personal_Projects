...
label = tk.Label(root, text="PASSWORD MANAGER", font=("Helvetica", 24, "bold"))
label.pack(pady=100)
user_database = {
...
def on_change_password_click():
    ...
    button_change_password = tk.Button(change_password_window, text="Change Password", command=confirm_change_password)
...
def on_set_password_click():
    if not read_password_status_from_file():
        ...
        button_set_password = tk.Button(set_password_window, text="Set Password", command=confirm_set_password)
...
button_change_password = tk.Button(root, text="Change Password", command=on_change_password_click)
button_change_password.pack()

button_set_password = tk.Button(root, text="Set Password", command=on_set_password_click)
button_set_password.pack()
